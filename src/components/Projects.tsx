...
export const Projects = (): React.JSX.Element => (
	<Box py={5}>
		...
		<Box my={2}>
			...
			/>
			<DescriptionParagraph
				text='Lexicon is a word list app in which they can add words and have them saved long term, building their own personal dictionary. My primary motivation for creating Lexicon was to have a user interface that better suits my needs than any existing ones.'
			/>
		</Box>
		<Divider sx={{ borderColor: '#333333', borderWidth: '1px', width: '100%', margin: 'auto' }} />
		<Box my={2}>
